...
| **Bootstrap SDL** | Server health/connectivity fields (`hello`, `status`, `ping`, `pingSent`) are generated by `@corpdk/dal-codegen` alongside entity SDL — no manual `src/schema/` files in `templates/ds` |
