...
| -------------------------------------------- | ---------- | ------------------ | ------------------------------ |
| `relational` + `prisma`                      | Prisma     | `@corpdk/ds-no-sql`| `standard` only                |
| `relational` + `drizzle`                     | Drizzle    | `@corpdk/ds`       | `hprt` only                    |
...
| `document` + MongoDB/DocumentDB + `standard` | Prisma     | `@corpdk/ds-no-sql`| `standard` only                |
