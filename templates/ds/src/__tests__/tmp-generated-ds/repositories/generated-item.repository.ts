...
import { categories, itemDetails, items, itemTags } from "../../../db/schema/index.js";
...
export class GeneratedItemRepository {
  ...
  async findByCategoryIds(categoryIds: string[]): Promise<Map<string, ItemRecord[]>> {
    ...
    const rows = await db.select().from(table).where(and(inArray(table.categoryId, unique), isNull(table.deletedAt))!);
