...
export class GeneratedItemDetailRepository {
  ...
  async create(input: ItemDetailCreateInput, ctx: RepositoryContext, conn: typeof db = db) {
    try {
  ...
  async update(id: string, input: ItemDetailUpdateInput, ctx: RepositoryContext, conn: typeof db = db) {
    try {
      assertValidUuid(id);
