...
export class GeneratedCategoryRepository {
  ...
  async create(input: CategoryCreateInput, ctx: RepositoryContext, conn: typeof db = db) {
    try {
  ...
  async update(id: string, input: CategoryUpdateInput, ctx: RepositoryContext, conn: typeof db = db) {
    try {
      assertValidUuid(id);
