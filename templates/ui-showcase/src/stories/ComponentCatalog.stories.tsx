...
const CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    render: () => <Input placeholder="Type something..." className="max-w-[200px]" />,
  },
  {
    name: 'Textarea',
    category: 'Data Entry',
    storyId: 'ui-core-data-entry-textarea',
    render: () => <Textarea placeholder="Write here..." className="max-w-[200px] h-16" />,
  },
  {
    name: 'Checkbox',
    category: 'Data Entry',
  ...
  },
  {
    ...
    render: () => <Slider defaultValue={[50]} max={100} className="w-[180px]" />,
  },
  {
    name: 'Toggle',
    category: 'Data Entry',
    ...
    render: () => (
      <Accordion type="single" collapsible className="w-[220px]">
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-sm py-2">Section One</AccordionTrigger>
  ...
  },
  {
    ...
    render: () => (
      <span className="text-xs text-muted-foreground">Hover-triggered card</span>
    ),
  },
  {
    name: 'Collapsible',
  ...
  // Navigation
  {
    ...
    render: () => (
      <Tabs defaultValue="tab1" className="w-[220px]">
        ...
        <TabsContent value="tab1" className="text-xs p-2">First tab</TabsContent>
        <TabsContent value="tab2" className="text-xs p-2">Second tab</TabsContent>
      </Tabs>
    ),
  },
  {
...
const CATEGORIES = ['Data Entry', 'Data Display', 'Feedback', 'Layout', 'Navigation'] as const;
...
function CatalogCard({ entry }: { entry: CatalogEntry }) {
  ...
  return (
    ...
    >
      <div className="mb-3 flex min-h-[48px] items-center">{entry.render()}</div>
...
function ComponentCatalog() {
  return (
    <div className="mx-auto max-w-5xl space-y-10 p-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Component Catalog</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          {CATALOG.length} components available in <code className="text-xs">@corpdk/ui-core</code>.
          Click any component to view its full documentation and stories.
        </p>
      </div>
